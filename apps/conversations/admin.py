...
from .models import (
    Conversation, Message, ConversationSummary, ConversationBranch,
    Call, MessageReadStatus, ChatMemory, ConversationTemplate,
)
...
class CallAdmin(admin.ModelAdmin):
    ...
    list_display = ['caller', 'callee', 'call_type', 'status', 'duration_seconds', 'started_at', 'ended_at', 'created_at']
    list_filter = ['call_type', 'status', 'created_at']
    search_fields = ['caller__email', 'caller__display_name', 'callee__email', 'callee__display_name']
    ordering = ['-created_at']
...
class ChatMemoryAdmin(admin.ModelAdmin):
    ...
    list_display = ['user', 'key', 'importance', 'is_active', 'created_at', 'updated_at']
