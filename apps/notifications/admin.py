...
class NotificationAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Basic Info", {"fields": ("user", "notification_type", "title", "body")}),
        ("Data & Deep Linking", {"fields": ("data",), "classes": ("collapse",)}),
        ("Scheduling", {"fields": ("scheduled_for", "status", "sent_at", "read_at")}),
        (
            "Retry Logic",
            {
...
class NotificationTemplateAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Basic Info", {"fields": ("name", "notification_type", "is_active")}),
        (
            "Template",
...
def bulk_send_view(request):
    ...
    return render(
        request,
        "admin/notifications/bulk_send.html",
        {
