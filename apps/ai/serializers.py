"""
Serializers for AI Coaching app.
"""
...
class AIMessageSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        extra_kwargs = {
            ...
            "conversation": {"help_text": "AI conversation this message belongs to."},
...
class AIMessageCreateSerializer(serializers.Serializer):
    """Serializer for creating/sending an AI message."""
...
class AIConversationSerializer(serializers.ModelSerializer):
    """Basic serializer for AIConversation model."""

    dream_title = serializers.CharField(
        source="dream.title",
        read_only=True,
        allow_null=True,
        help_text="Title of the linked dream.",
    )
    ...
    class Meta:
        ...
        extra_kwargs = {
            ...
            "conversation_type": {
                "help_text": "Type of conversation (e.g., general, planning)."
            },
            "total_messages": {
                "help_text": "Total number of messages in the conversation."
            },
            "total_tokens_used": {
                "help_text": "Total AI tokens consumed in this conversation."
            },
...
class AIConversationDetailSerializer(serializers.ModelSerializer):
    """Detailed serializer for AIConversation with messages (latest 50)."""
    ...
    def get_messages(self, obj):
        ...
        return AIMessageSerializer(reversed(list(msgs)), many=True).data
...
class AIConversationCreateSerializer(serializers.ModelSerializer):
    ...
    def validate_conversation_type(self, value):
        ...
        valid_types = [choice[0] for choice in AIConversation.TYPE_CHOICES]
        if value not in valid_types:
            raise serializers.ValidationError(
                _("Invalid conversation type. Must be one of: %(types)s")
    ...
    def validate(self, attrs):
        ...
        if conv_type in dream_required_types and not dream:
            raise serializers.ValidationError(
                _(
                    "Conversations of type '%(type)s' must be linked to a dream. "
                    "Please provide a dream ID."
                )
                % {"type": conv_type}
            )
        return attrs
...
class ConversationSummarySerializer(serializers.ModelSerializer):
    """Serializer for AI Conversation summaries."""
    ...
    class Meta:
        ...
        extra_kwargs = {
            ...
            "conversation": {"help_text": "AI conversation this summary belongs to."},
            "summary": {
                "help_text": "AI-generated summary of the conversation segment."
            },
...
class AIMessageSearchSerializer(serializers.ModelSerializer):
    """Serializer for AI message search results with highlighted content excerpt."""

    excerpt = serializers.SerializerMethodField(
        help_text="Content excerpt with search term highlighted in <mark> tags."
    )
...
class ConversationBranchSerializer(serializers.ModelSerializer):
    ...
    message_count = serializers.SerializerMethodField(
        help_text="Number of messages in this branch."
    )
    ...
    class Meta:
        ...
        extra_kwargs = {
            ...
            "conversation": {"help_text": "AI conversation this branch belongs to."},
