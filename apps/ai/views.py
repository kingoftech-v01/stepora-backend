"""
Views for AI Coaching app.

All AI conversation features: send message (OpenAI), voice, image,
summarize, branches, templates, memories.
"""
...
@extend_schema_view(
    list=extend_schema(
        ...
        description="Get all AI coaching conversations for the current user",
        tags=["AI Coaching"],
        responses={
            200: AIConversationSerializer(many=True),
            403: OpenApiResponse(description="Subscription required."),
        },
    ),
    create=extend_schema(
        summary="Create AI conversation",
        description="Create a new AI coaching conversation",
        tags=["AI Coaching"],
        responses={
            201: AIConversationSerializer,
    ...
    retrieve=extend_schema(
        ...
        tags=["AI Coaching"],
        responses={
            200: AIConversationDetailSerializer,
            403: OpenApiResponse(description="Subscription required."),
    ...
    update=extend_schema(
        ...
        tags=["AI Coaching"],
        responses={
            200: AIConversationSerializer,
            403: OpenApiResponse(description="Subscription required."),
            404: OpenApiResponse(description="Not found."),
        },
    ),
    partial_update=extend_schema(
        summary="Partial update AI conversation",
        description="Partially update an AI conversation",
        tags=["AI Coaching"],
        responses={
            200: AIConversationSerializer,
            403: OpenApiResponse(description="Subscription required."),
...
class AIConversationViewSet(viewsets.ModelViewSet):
    ...
    def get_permissions(self):
        """Require CanUseAI for all write actions."""
        if self.action in (
            "create",
            "send_message",
            "send_voice",
    ...
    def create(self, request, *args, **kwargs):
        """Create AI conversation and return full serialized object."""
        serializer = self.get_serializer(data=request.data)
        serializer.is_valid(raise_exception=True)
        conversation = serializer.save(user=request.user)
        # Return full representation with id
        response_serializer = AIConversationSerializer(
    ...
    def send_message(self, request, pk=None):
        ...
        # Validate message
        message_serializer = AIMessageCreateSerializer(data=request.data)
        ...
        try:
            ...
            try:
                ...
                room = f"ai_chat_{conversation.id}"
    ...
    def send_voice(self, request, pk=None):
        ...
        if audio_duration is not None:
            try:
                ...
                pass
        AIMessage.objects.filter(id=message.id).update(**update_kwargs)
    ...
    def summarize_voice(self, request, pk=None, message_id=None):
        """Summarize a specific voice message in the AI conversation."""
        conversation = self.get_object()
    ...
    def send_image(self, request, pk=None):
        """Send an image for GPT-4 Vision analysis in the AI conversation context."""
        from django.core.files.storage import default_storage
        ...
        AIMessage.objects.filter(id=user_message.id).update(image_url=image_url)
            ...
            return Response(
                {
                    "user_message": AIMessageSerializer(
                        AIMessage.objects.get(id=user_message.id)
                    ).data,
                    "assistant_message": AIMessageSerializer(assistant_message).data,
                }
            )
    ...
    @extend_schema(
        summary="Get AI messages",
        description="Get all messages for an AI conversation",
        tags=["AI Coaching"],
        responses={
            200: AIMessageSerializer(many=True),
            403: OpenApiResponse(description="Subscription required."),
            404: OpenApiResponse(description="Not found."),
        },
    )
    ...
    @extend_schema(
        summary="Pin AI conversation",
        description="Pin/unpin an AI conversation",
        tags=["AI Coaching"],
        responses={
            200: AIConversationSerializer,
            403: OpenApiResponse(description="Subscription required."),
    ...
    def pin(self, request, pk=None):
        """Toggle pin status on an AI conversation."""
        conversation = self.get_object()
    ...
    @extend_schema(
        summary="Pin AI message",
        description="Pin/unpin a message in an AI conversation",
        tags=["AI Coaching"],
        responses={
            200: AIMessageSerializer,
            403: OpenApiResponse(description="Subscription required."),
            404: OpenApiResponse(description="Not found."),
        },
    )
    ...
    @extend_schema(
        summary="Like AI message",
        description="Toggle like on an AI message",
        tags=["AI Coaching"],
        responses={
            200: AIMessageSerializer,
            403: OpenApiResponse(description="Subscription required."),
    ...
    @extend_schema(
        ...
        description="Add a reaction emoji to an AI message",
        tags=["AI Coaching"],
        responses={
            200: AIMessageSerializer,
            400: OpenApiResponse(description="Validation error."),
    ...
    def react_message(self, request, pk=None, message_id=None):
        """Add or remove a reaction on an AI message."""
        conversation = self.get_object()
        try:
            message = conversation.messages.get(id=message_id)
        except AIMessage.DoesNotExist:
    ...
    @extend_schema(
        ...
        description="Search messages within an AI conversation by keyword.",
        tags=["AI Coaching"],
        responses={
            200: AIMessageSearchSerializer(many=True),
            403: OpenApiResponse(description="Subscription required."),
            404: OpenApiResponse(description="Not found."),
        },
    )
    ...
    def search(self, request, pk=None):
        """Search messages within an AI conversation by content keyword."""
        conversation = self.get_object()
    ...
    @extend_schema(
        summary="Export AI conversation",
        description="Export an AI conversation as JSON or PDF",
        tags=["AI Coaching"],
        responses={
            200: dict,
            403: OpenApiResponse(description="Subscription required."),
    ...
    def export(self, request, pk=None):
        """Export AI conversation in JSON or PDF format."""
        conversation = self.get_object()
        ...
        if export_format == "pdf":
            try:
                ...
                story.append(
                    Paragraph(
                        f"AI Conversation: {conversation.conversation_type}",
                        styles["Title"],
                    )
                )
                ...
                response["Content-Disposition"] = (
                    f'attachment; filename="ai_conversation_{conversation.id}.pdf"'
                )
                return response
    ...
    @extend_schema(
        ...
        description="Archive (deactivate) an AI conversation.",
        tags=["AI Coaching"],
        responses={200: AIConversationSerializer},
    )
    @action(detail=True, methods=["post"])
    def archive(self, request, pk=None):
        """Archive an AI conversation by setting is_active=False."""
        conversation = self.get_object()
    ...
    def create_branch(self, request, pk=None):
        """Create a branch from a specific message in the AI conversation."""
        conversation = self.get_object()
    ...
    @extend_schema(
        ...
        description="List all branches for an AI conversation.",
        tags=["AI Coaching"],
    ...
    def list_branches(self, request, pk=None):
        """List all branches for an AI conversation."""
        conversation = self.get_object()
...
@extend_schema_view(
    list=extend_schema(
        ...
        description="Get all AI messages for the current user",
        tags=["AI Coaching"],
    ),
    retrieve=extend_schema(
...
class AIMessageViewSet(viewsets.ReadOnlyModelViewSet):
    """Read-only access to AI messages."""
    ...
    def get_queryset(self):
        """Get AI messages for current user's conversations."""
        if getattr(self, "swagger_fake_view", False):
            return AIMessage.objects.none()
        return (
            AIMessage.objects.filter(conversation__user=self.request.user)
...
@extend_schema_view(
    list=extend_schema(
        summary="List AI conversation templates",
        description="Get all available AI conversation templates",
        tags=["AI Coaching"],
    ),
    retrieve=extend_schema(
        summary="Get AI template",
        description="Get a specific AI conversation template",
        tags=["AI Coaching"],
    ),
)
class ConversationTemplateViewSet(viewsets.ReadOnlyModelViewSet):
    """Read-only access to AI conversation templates."""
...
@extend_schema_view(
    list=extend_schema(
        summary="List AI chat memories",
        description="Get all active AI chat memories for the current user.",
        tags=["AI Coaching"],
        responses={200: ChatMemorySerializer(many=True)},
    ),
    destroy=extend_schema(
        summary="Delete an AI chat memory",
        description="Delete a specific AI chat memory by ID.",
        tags=["AI Coaching"],
        responses={204: None},
    ),
)
class ChatMemoryViewSet(viewsets.GenericViewSet):
    ...
    user's persistent AI chat memories.
    """
    ...
    def list(self, request):
        """List all active AI memories for the current user."""
        queryset = self.get_queryset()
        serializer = self.get_serializer(queryset, many=True)
        return Response(serializer.data)

    def destroy(self, request, pk=None):
        """Delete (deactivate) a specific AI memory."""
        try:
    ...
    @extend_schema(
        summary="Clear all AI chat memories",
        description="Deactivate all AI chat memories for the current user.",
        tags=["AI Coaching"],
        responses={200: OpenApiResponse(description="All memories cleared.")},
    )
    @action(detail=False, methods=["post"], url_path="clear")
    def clear_all(self, request):
        """Deactivate all AI memories for the current user."""
