...
class Post(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(
                fields=["status", "-published_at"], name="idx_blogpost_status_pub"
            ),
            models.Index(
                fields=["category", "-published_at"], name="idx_blogpost_cat_pub"
            ),
            models.Index(
                fields=["featured", "-published_at"], name="idx_blogpost_featured_pub"
            ),
            models.Index(fields=["-created_at"], name="idx_blogpost_created"),
            models.Index(
                fields=["author", "-published_at"], name="idx_blogpost_author_pub"
            ),
        ]
