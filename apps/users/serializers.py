...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'onboarding_completed', 'dreamer_type',
            'created_at', 'updated_at'
        ]
        read_only_fields = ['id', 'email', 'subscription', 'subscription_ends', 'xp', 'level', 'streak_days', 'last_activity', 'email_verified', 'onboarding_completed', 'dreamer_type', 'created_at', 'updated_at']
        extra_kwargs = {
...
class GamificationProfileSerializer(serializers.ModelSerializer):
    ...
    health_level = serializers.SerializerMethodField(help_text='Computed level for health category.')
    career_level = serializers.SerializerMethodField(help_text='Computed level for career category.')
    relationships_level = serializers.SerializerMethodField(help_text='Computed level for relationships category.')
    personal_growth_level = serializers.SerializerMethodField(help_text='Computed level for personal growth category.')
    finance_level = serializers.SerializerMethodField(help_text='Computed level for finance category.')
    hobbies_level = serializers.SerializerMethodField(help_text='Computed level for hobbies category.')
    skill_radar = serializers.SerializerMethodField(help_text='Skill radar data across all categories.')
    ...
    class Meta:
        ...
        extra_kwargs = {
            ...
            'relationships_xp': {'help_text': 'Experience points in relationships category.'},
            'personal_growth_xp': {'help_text': 'Experience points in personal growth category.'},
