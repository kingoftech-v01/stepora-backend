...
from .views import (
    ...
    CalendarMySharesView,
    CalendarSharedWithMeView,
    CalendarShareLinkView,
    CalendarShareRevokeView,
    CalendarShareView,
    CalendarViewSet,
    FocusBlockEventsView,
    FocusModeActiveView,
    ...
    ICalFeedView,
    ICalImportView,
    SharedCalendarSuggestView,
    SharedCalendarView,
    SmartScheduleView,
    TimeBlockTemplateViewSet,
    TimeBlockViewSet,
)
...
router.register(
    r"timeblock-templates", TimeBlockTemplateViewSet, basename="timeblock-template"
)
...
urlpatterns = [
    ...
    path(
        ...
        GoogleCalendarNativeRedirectView.as_view(),
        name="google-calendar-native-callback",
    ),
    ...
    path(
        "shared-with-me/",
        CalendarSharedWithMeView.as_view(),
        name="calendar-shared-with-me",
    ),
    path("my-shares/", CalendarMySharesView.as_view(), name="calendar-my-shares"),
    path(
        "share/<uuid:share_id>/",
        CalendarShareRevokeView.as_view(),
        name="calendar-share-revoke",
    ),
    path("share-link/", CalendarShareLinkView.as_view(), name="calendar-share-link"),
    path(
        "shared/<str:token>/", SharedCalendarView.as_view(), name="shared-calendar-view"
    ),
    path(
        "shared/<str:token>/suggest/",
        SharedCalendarSuggestView.as_view(),
        name="shared-calendar-suggest",
    ),
    # Router URLs
