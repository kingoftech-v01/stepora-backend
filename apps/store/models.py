...
class StoreCategory(models.Model):
    ...
    name = models.CharField(
        max_length=100, unique=True, help_text="Display name of the category."
    )
    slug = models.SlugField(
        max_length=100, unique=True, help_text="URL-friendly slug for the category."
    )
    description = models.TextField(
        blank=True, default="", help_text="Description of the category shown to users."
    )
    ...
    display_order = models.IntegerField(
        default=0, help_text="Order in which the category appears in the store."
    )
    is_active = models.BooleanField(
        default=True, help_text="Whether the category is visible in the store."
    )
...
class StoreItem(models.Model):
    ...
    name = models.CharField(max_length=200, help_text="Display name of the item.")
    slug = models.SlugField(
        max_length=200, unique=True, help_text="URL-friendly slug for the item."
    )
    description = models.TextField(
        blank=True, default="", help_text="Description of the item shown to users."
    )
    ...
    is_active = models.BooleanField(
        default=True, help_text="Whether the item is available for purchase."
    )
    created_at = models.DateTimeField(
        auto_now_add=True, help_text="Timestamp when the item was added to the store."
    )
...
class UserInventory(models.Model):
    ...
    purchased_at = models.DateTimeField(
        auto_now_add=True, help_text="Timestamp when the item was purchased."
    )
