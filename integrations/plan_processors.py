...
def detect_language(text: str) -> str:
    ...
    # French indicators
    fr_words = ['je', 'veux', 'mon', 'ma', 'mes', 'une', 'des', 'les', 'dans', 'pour',
                'avec', 'sur', 'est', 'sont', 'faire', 'cette', 'mais', 'pas', 'que',
                'qui', 'aussi', 'plus', 'tout', 'être', 'avoir', 'aller']
    # English indicators
    en_words = ['i ', 'my', 'the', 'and', 'to ', 'a ', 'in ', 'for', 'with', 'want',
                'get', 'have', 'this', 'that', 'from', 'will', 'can', 'more', 'just',
                'be ', 'not', 'all', 'would', 'make', 'like', 'so ']
    # Spanish indicators
    es_words = ['yo ', 'mi ', 'quiero', 'para', 'con', 'una', 'los', 'las', 'por',
                'como', 'más', 'pero', 'este', 'esta', 'todo', 'hacer', 'ser']
...
KEYWORD_MAP = {
    'health': [
        'courir', 'running', 'marathon', 'gym', 'muscul', 'yoga', 'sport',
        'perdre du poids', 'lose weight', 'maigrir', 'fitness', 'exercise',
        'santé', 'health', 'méditation', 'natation', 'swim', 'vélo', 'cycling',
        'boxe', 'boxing', 'martial', 'karate', 'judo', 'abdos', 'pompes',
        'poids', 'kg', 'kilos', 'diet', 'régime', 'nutrition',
    ],
    'finance': [
        'riche', 'rich', 'argent', 'money', 'invest', 'bourse', 'stock',
        'épargne', 'saving', 'budget', 'financ', 'crypto', 'bitcoin',
        'patrimoine', 'wealth', 'revenus passifs', 'passive income',
        'immobilier', 'real estate', 'retraite', 'retirement',
    ],
    'career': [
        'business', 'entreprise', 'startup', 'boutique', 'commerce',
        'carrière', 'career', 'promotion', 'freelance', 'emploi', 'job',
        'salaire', 'salary', 'entrepreneur', 'vendre', 'sell', 'client',
        'manager', 'leadership', 'side hustle', 'e-commerce',
    ],
    'language': [
        'langue', 'language', 'japonais', 'japanese', 'anglais', 'english',
        'espagnol', 'spanish', 'allemand', 'german', 'chinois', 'chinese',
        'coréen', 'korean', 'arabe', 'arabic', 'italien', 'italian',
        'portugais', 'portuguese', 'russe', 'russian',
        'jlpt', 'delf', 'toefl', 'ielts', 'toeic', 'hsk',
    ],
    'creative': [
        'guitare', 'guitar', 'piano', 'musique', 'music', 'chant', 'sing',
        'peindre', 'paint', 'dessin', 'draw', 'photo', 'écrire', 'write',
        'roman', 'novel', 'cuisine', 'cook', 'recette', 'recipe',
        'danse', 'dance', 'sculpture', 'poterie', 'pottery', 'tricot',
        'instrument', 'violon', 'violin', 'batterie', 'drums',
    ],
    'personal_development': [
        'habitude', 'habit', 'confiance', 'confidence', 'méditer',
        'meditat', 'lire', 'read', 'livre', 'book', 'journal',
        'productiv', 'discipline', 'organisation', 'organiz',
        'anxiété', 'anxiety', 'stress', 'mindfulness', 'bien-être',
        'public speaking', 'parler en public', 'motivation',
        'changer ma vie', 'meilleure version', 'transformer',
        'développement personnel', 'self improvement', 'routine',
        'se lever tôt', 'procrastin', 'objectifs', 'goals',
    ],
    'relationships': [
        'ami', 'friend', 'relation', 'dating', 'rencontre', 'meet',
        'réseau', 'network', 'social', 'famille', 'family',
        'couple', 'mariage', 'marriage', 'communication',
        'timide', 'shy', 'timidité', 'solitude', 'introverti',
        'sortir plus', 'parler aux gens', 'confiance en soi',
    ],
    'tech': [
        'programm', 'coder', 'coding', 'python', 'javascript', 'web dev',
        'développ', 'develop', 'appli', 'logiciel', 'software',
        'data science', 'machine learning', 'intelligence artificielle',
        'cybersécurité', 'cybersecurity', 'cloud computing', 'devops',
        'api', 'base de données', 'database', 'frontend', 'backend',
        'react', 'django', 'flutter', 'html', 'css',
    ],
    'travel': [
        'voyage', 'travel', 'trek', 'randonn', 'hike', 'hiking',
        'escalade', 'climb', 'plongée', 'diving', 'surf', 'ski',
        'parachute', 'aventure', 'adventure', 'backpack', 'tour du monde',
        'mont blanc', 'camping', 'tente', 'bivouac', 'sentier',
        'montagne', 'mountain', 'altitude', 'expédition', 'expedition',
        'road trip', 'sac à dos', 'autonomie',
    ],
    'education': [
        'examen', 'exam', 'diplôme', 'degree', 'université', 'university',
        'bac', 'concours', 'certifi', 'formation', 'training',
        'étude', 'study', 'master', 'licence', 'doctorat', 'phd',
        'permis', 'driving license', "driver's license",
        'réussir', 'passer le', 'préparer le', 'réviser',
    ],
}
